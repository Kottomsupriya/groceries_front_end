        ...
        switch(name){
            case 'title':
                ...
                submitData = e=>{
                    ...
                    if(visited.title && visited.quantity  && visited.price && visited.description ){
                        if(errors.title.length===0 && errors.quantity.length===0 && errors.price.length===0 && errors.description.length===0 ){
